...
def get_book_info(book_id,content_type = 8):
    ...
    :return:
    '''
    url = 'https://kol.fanqieopen.com/api/platform/content/book/list/v:version?book_id='+str(book_id)+'&content_tab=2&genre='+str(content_type)+'&app_id=457699&msToken=rSD3w0nckkw6RC20uPyd7mnQDaD0vUIiyte_hYMNpEVSo47Z0opes99Tpbyd8szp7Ka-q5fPq2e-Ex2tboZX66LIhgkHaGKRWwkC2eQ6A2oKrLL0ro3zEB7ZCWLrMsH4&X-Bogus=DFSzswVuwgkANy2ltEgs2fLNKBYJ'
